...
export default function UnifiedAdminPage() {
  ...
  React.useEffect(() => {
    ...
    }, 200); // light debounce for search input
    return () => {
      cancelled = true;
  ...
  return (
    <div className="w-full space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Unified View</h1>
      ...
      {error ? (
        <div className="rounded-xl border border-red-200 bg-red-50 p-4">
          <div className="text-sm font-medium text-red-800">Failed to load unified dashboard</div>
